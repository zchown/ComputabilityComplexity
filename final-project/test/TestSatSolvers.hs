  ...
  hspec $ do
    describe "dpll" $ do
      it "unsatisfiable problem - simple contradiction" $ do
        ...
        dpll problem `shouldBe` S.Unsatisfiable
      ...
      it "unsatisfiable problem with unit propagation" $ do
        ...
        dpll problem `shouldBe` S.Unsatisfiable
    describe "GSAT" $ do
      it "single variable single clause problem" $ do
